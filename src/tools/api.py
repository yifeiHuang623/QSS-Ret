...
from src.tools.api_lib.llama import complete_text_llama
...
registered_text_completion_llms = {
    ...
    "/home/huangyf/llm/llm_model/Meta-Llama-3-8B-Instruct"
}
...
def get_llm_output(message, 
                   llm_model_pt,
                   tokenizer,
                   model="/home/huangyf/llm/llm_model/Meta-Llama-3-8B-Instruct", 
                   max_tokens=2048, 
                   temperature=1, 
                   json_object=False
                   ):
    ...
    if 'gpt-4' in model:
        ...
        return complete_text_llama(llm_model_pt, tokenizer, **kwargs)
    else:
